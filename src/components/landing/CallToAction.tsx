        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <Text size="xl" className="text-blue-100">
              Join the community of workers and students mastering their tasks
              with Task Wise, an open source solution.
            </Text>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-12 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <Text className="text-blue-100">Open Source</Text>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-white mb-2">
                🛠️
              </div>
              <Text className="text-blue-100">Customizable</Text>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-white mb-2">
                🤝
              </div>
              <Text className="text-blue-100">Community Powered</Text>
            </div>
          </div>
        </div>
      </div>
